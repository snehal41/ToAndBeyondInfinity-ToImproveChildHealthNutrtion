...
<div class="card">
            <!-- main-heading -->
            <br>
            <h3 class="main-title-w3layouts mb-2 text-center">Upload Digital Resources</h2>
            <!--// main-heading -->
            <br>
            <!-- Error Page Content -->
        ...
        <div id="page-wrapper"> 
            ...
            <h4 class="text-center"> (Ministry can upload videos , images From Here to Home Page)</h4>

            <form action="receive.php" method="post" enctype="multipart/form-data"><br>

            <br>

                    Enter the file for upload :<input type="file" name="anyfile"  required="required"/><br><br><br>
                    Enter the expire/deadline date: <input type="date" name="date" required="required"><br><br><br>
                    Enter Category:<select id="cat" name="cat" >
                    <option value="">Select Category</option>
                    <option name="cat" value="training courses">Training Courses</option>
                    <option name="cat" value="women care">Women Care</option>
                    <option name="cat" value="child care">Child Care</option>

                            </select>
            </br>
            </br></br>
            <center><button type="submit" name="btn-upload">Upload</button></center>
