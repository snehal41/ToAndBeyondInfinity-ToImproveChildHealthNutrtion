...
<div class="container-fluid mt-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <h4 style="font-variant-caps: all-petite-caps;color: #ff1a17"><b>Finance</b></h4>
            <p>Submit your bank account details along with (Account number,IFSC,brach name ) along with hard copy of
                ticket to maam</p>
            <font size="2px">
                <?php
                echo date("d-m-Y");
