...
<head>
    ...
    <!-- Title Page-->
    <title>Login | Central Ministry</title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/msme_logo.png" alt="MSME DI PATNA" width="10%" height="40%">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="process.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="user" placeholder="Login ID">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="register-link">
                                <p>
                                    ...
                                    <a href="phcreg.php">Sign Up Here</a>
                                </p>
                            </div>
                        </div>
                    </div>
