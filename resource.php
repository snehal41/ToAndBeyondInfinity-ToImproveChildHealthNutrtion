...
<div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto">
        ...
        <div class="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
            <a class="dropdown-item" href="resource.php?cat=tc">Training Courses</a>
            <a class="dropdown-item" href="resource.php?cat=wc">Women Care</a>
            <a class="dropdown-item" href="resource.php?cat=cc">Child Care</a>
        </div>
    </li>
    <li class="nav-item">
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-3">
            ...
            <div class="pic-container">
                <iframe class="mb-3" width="90%" height="40%" src="https://www.youtube.com/embed/wGvr4S33tW4" frameborder="0"
        ...
        <div class="col-md-9">
            ...
            switch($category){
                case "tc":
                ?>
                <h2 class="mb-5"><b>Digital Resources For Training Cources</b></h2>
                <?php

                $query = "SELECT * FROM digital_resources where Category='training courses'";
               ...
               case "wc":
               ?>
               <h2 class="mb-5"><b>Digital Resources For Women Care</b></h2>
               <?php
               break;
               case "cc":
               ?>
               <h2 class="mb-5"><b>Digital Resources For Child Care</b></h2>
               <?php
               break;
           }?>
       </div>
